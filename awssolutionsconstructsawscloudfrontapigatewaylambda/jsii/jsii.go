...
import (
	...
	awssolutionsconstructsawscloudfrontapigateway "github.com/christian-korneck/awssc-go-dist/awssolutionsconstructsawscloudfrontapigateway/v2/jsii"
	awssolutionsconstructscore                    "github.com/christian-korneck/awssc-go-dist/awssolutionsconstructscore/v2/jsii"
)

//go:embed aws-solutions-constructs-aws-cloudfront-apigateway-lambda-2.2.0.tgz
var tarball []byte
...
func Initialize() {
	...
	awssolutionsconstructsawscloudfrontapigateway.Initialize()
	awssolutionsconstructscore.Initialize()
	awscdk.Initialize()
	constructs.Initialize()

	// Load this library into the kernel
	_jsii_.Load("@aws-solutions-constructs/aws-cloudfront-apigateway-lambda", "2.2.0", tarball)
}
