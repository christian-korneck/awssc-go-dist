...
//go:embed aws-solutions-constructs-aws-lambda-ssmstringparameter-2.2.0.tgz
var tarball []byte
...
func Initialize() {
	...
	_jsii_.Load("@aws-solutions-constructs/aws-lambda-ssmstringparameter", "2.2.0", tarball)
}
