...
import (
	...
	awssolutionsconstructsawseventbridgestepfunctions "github.com/christian-korneck/awssc-go-dist/awssolutionsconstructsawseventbridgestepfunctions/v2/jsii"
	awssolutionsconstructscore                        "github.com/christian-korneck/awssc-go-dist/awssolutionsconstructscore/v2/jsii"
)

//go:embed aws-solutions-constructs-aws-s3-stepfunctions-2.2.0.tgz
var tarball []byte
...
func Initialize() {
	...
	awssolutionsconstructsawseventbridgestepfunctions.Initialize()
	awssolutionsconstructscore.Initialize()
	awscdk.Initialize()
	constructs.Initialize()

	// Load this library into the kernel
	_jsii_.Load("@aws-solutions-constructs/aws-s3-stepfunctions", "2.2.0", tarball)
}
