...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IotToKinesisFirehoseToS3)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@aws-solutions-constructs/aws-iot-kinesisfirehose-s3.IotToKinesisFirehoseToS3Props",
		reflect.TypeOf((*IotToKinesisFirehoseToS3Props)(nil)).Elem(),
	)
}
