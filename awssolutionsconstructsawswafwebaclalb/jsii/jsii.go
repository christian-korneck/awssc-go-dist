...
import (
	...
	awssolutionsconstructsawsroute53alb "github.com/christian-korneck/awssc-go-dist/awssolutionsconstructsawsroute53alb/v2/jsii"
	awssolutionsconstructscore          "github.com/christian-korneck/awssc-go-dist/awssolutionsconstructscore/v2/jsii"
)

//go:embed aws-solutions-constructs-aws-wafwebacl-alb-2.2.0.tgz
var tarball []byte
...
func Initialize() {
	...
	awssolutionsconstructsawsroute53alb.Initialize()
	awssolutionsconstructscore.Initialize()
	awscdk.Initialize()
	constructs.Initialize()

	// Load this library into the kernel
	_jsii_.Load("@aws-solutions-constructs/aws-wafwebacl-alb", "2.2.0", tarball)
}
