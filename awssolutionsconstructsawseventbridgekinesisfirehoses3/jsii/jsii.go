...
//go:embed aws-solutions-constructs-aws-eventbridge-kinesisfirehose-s3-2.2.0.tgz
var tarball []byte
...
func Initialize() {
	...
	_jsii_.Load("@aws-solutions-constructs/aws-eventbridge-kinesisfirehose-s3", "2.2.0", tarball)
}
